...
function addMsg(msg, prepend) {
    ...
    if (!isSelfSend){
        ...
        addMessage("OTHER", convertMsgtoHtml(msg), fromAccount, fromAccountNick, fromAccountImage, msg.time);
    } else {
        addMessage("MYSELF", convertMsgtoHtml(msg), fromAccount, fromAccountNick, fromAccountImage, msg.time);
    }
